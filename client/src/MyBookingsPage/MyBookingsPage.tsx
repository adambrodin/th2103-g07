...
const MyBookingsPage = () => {
  ...
  return (
    <div style={{ color: '#b0eba2' }} className='container text-center'>
      <h1>Sök Bokning </h1>
      <SearchBookingComponent
        searchFuntion={searchForBooking}></SearchBookingComponent>
      {showBooking && (
        <div className='container booking-container'>
          <Card variant='outlined' sx={{ minWidth: 260, width: 400 }}>
            <BookingComponent
              booking={bookingExample}
              deleteFunction={deleteBooking}></BookingComponent>
          </Card>
        </div>
      )}
